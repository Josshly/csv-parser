...
template <typename Delimiter, typename QuoteChar, typename TrimPolicy>
bool Reader<Delimiter, QuoteChar, TrimPolicy>::getRow(
...
template <typename Delimiter, typename QuoteChar, typename TrimPolicy>
void Reader<Delimiter, QuoteChar, TrimPolicy>::parse(
